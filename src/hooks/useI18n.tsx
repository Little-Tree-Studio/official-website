...
const translations: Record<Lang, Record<string, string | string[]>> = {
  zh: {
    ...
    'team.kyle.bio': '专注于前端开发和性能优化，确保产品的高效稳定运行',
    'team.kyle.tags': '前端开发,性能优化,系统架构',
  ...
  en: {
    ...
    'team.kyle.bio': 'Focused on frontend development and performance optimization, ensuring efficient and stable product operation',
    'team.kyle.tags': 'Frontend,Performance,System Arch',
