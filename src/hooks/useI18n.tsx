...
const translations: Record<Lang, Record<string, string | string[]>> = {
  zh: {
    ...
    'products.clock.name': '小树时钟',
    'products.clock.desc': '功能丰富、高度可定制的桌面时钟应用，支持专注计时、闹钟、世界时钟、插件扩展',
    'products.clock.tags': '专注计时,插件系统,高度定制',
  ...
  en: {
    ...
    'products.clock.name': 'Little Tree Clock',
    'products.clock.desc': 'Feature-rich, highly customizable desktop clock app with focus timer, smart alarm, world clock, and plugin support',
    'products.clock.tags': 'Focus Timer,Plugin System,Customizable',
